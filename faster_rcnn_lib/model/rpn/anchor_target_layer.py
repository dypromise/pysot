...
class _AnchorTargetLayer(nn.Module):
    ...
    def forward(self, input):
        ...
        shifts = torch.from_numpy(np.vstack(
        ...
        overlaps = bbox_overlaps_batch(anchors, gt_boxes)  # b, A*K, N_boxes
        ...
        for i in range(batch_size):
            ...
            if sum_fg[i] > num_fg:
                ...
                # cause the segfault.
                # See https://github.com/pytorch/pytorch/issues/1868 for more
                # details. use numpy instead.
...
#           num_bg = cfg.TRAIN.RPN_BATCHSIZE - sum_fg[i]
        ...
        bbox_inside_weights = _unmap(
            bbox_inside_weights, total_anchors, inds_inside, batch_size,
            fill=0)
        bbox_outside_weights = _unmap(
            bbox_outside_weights, total_anchors, inds_inside, batch_size,
            fill=0)
        ...
        bbox_inside_weights = bbox_inside_weights.contiguous().view(
