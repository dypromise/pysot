...
from pysot.tracker.siamrcnn_tracker import SiamRCNNTracker
...
TRACKS = {
    ...
    'SiamRCNNTracker': SiamRCNNTracker,
    'SiamMaskTracker': SiamMaskTracker,
    'SiamRPNLTTracker': SiamRPNLTTracker
}


def build_tracker(model, **kwargs):
    return TRACKS[cfg.TRACK.TYPE](model, **kwargs)
